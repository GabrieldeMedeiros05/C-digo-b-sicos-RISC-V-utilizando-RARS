...
# a ordem de s0 e s1 IMPORTA
	rem a0,s0,s1 	# o primeiro registrador e onde vai ser salvo o resultado do resto da divisao
			# segundo registrador dividido pelo terceito registrador
			# a0 = s0%s1
