.text 			# instrucoes de assembly
	...
	li a7,5
	ecall		# lendo um segundo numero do teclado e salvando em a0
	
	mv s1,a0	# copiando para s1 o numero em a0 (s1 = a0)
	
	
	add a0,s0,s1 	# o primeiro registrador e onde vai ser salvo o resultado da soma
			# o segundo registrador vai ser somado com o terceito registrador
			# a0 = s0+s1
